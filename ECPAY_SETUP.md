...
3. **準備審核所需文件**
   ...
   **個人會員需要**：
   ...
   - 銀行存摺封面影本
   - 網站網址
   - 辦公環境照片（地址門牌、招牌、大門、辦公室環境、商品照、存貨照等）
   ...
   **商務會員需要**：
   ...
   - 公司存摺帳戶封面影本
   - 網站網址
   - 公司環境照片（地址門牌、招牌、大門、辦公室環境、商品照、存貨照等）
...
**範例連結**：
```
/refund 或 /refund-policy
```

#### 4. 聯絡資訊（Contact Information）
...
#### 5. 商品/服務描述（Product/Service Description）
...
- [ ] ✅ 商品/服務描述清楚明確
- [ ] ✅ 付款方式說明完整
- [ ] ✅ 所有條款連結在網站底部 Footer 可見
- [ ] ✅ 註冊/登入頁面有隱私權政策連結
- [ ] ✅ 付款頁面有相關條款連結

### 💡 加速審核小技巧

1. **完整性**：確保所有條款內容完整，不要只有標題
2. **可訪問性**：所有條款必須可以公開存取，不需要登入
3. **中文內容**：條款內容使用繁體中文
4. **明確標示**：在註冊/付款頁面明確標示「我已閱讀並同意服務條款與隱私政策」
5. **聯絡資訊真實**：確保聯絡資訊真實有效，綠界可能會驗證
6. **網站完整性**：網站功能正常，沒有明顯錯誤
